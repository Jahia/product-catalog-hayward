    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="box-1" ng-controller="folderPickerCtrl"
                 ng-init='init(${localFolders}, "${fn:escapeXml(xmlFactory.localPath)}", "localPath", true, "${i18NSelectTarget}")'>
                <form:form modelAttribute="xmlFactory" method="post" cssClass="form">
                    <fieldset title="local">
                        <div>
                            ...
                            <div class="form-group is-empty">
                                <form:label path="root" cssClass="control-label"><fmt:message key="xmlProvider.xmlpath"/> <span style="color: red">*</span></form:label>

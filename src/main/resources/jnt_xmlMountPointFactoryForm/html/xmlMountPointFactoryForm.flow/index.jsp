...
<%--@elvariable id="xmlFactory" type="org.jahia.modules.xmlprovider.factory.XmlMountPointFactory"--%>
...
<div class="folderPickerApp" ng-app="folderPicker">
    <h2><fmt:message key="xmlProvider.title"/></h2>
    <%@ include file="errors.jspf" %>

    <fmt:message var="selectTarget" key="xmlProvider.localmountpoint"/>
    <c:set var="i18NSelectTarget" value="${functions:escapeJavaScript(selectTarget)}"/>
    <div class="box-1" ng-controller="folderPickerCtrl" ng-init='init(${localFolders}, "${fn:escapeXml(xmlFactory.localPath)}", "localPath", true, "${i18NSelectTarget}")'>
        <form:form modelAttribute="xmlFactory" method="post">
            <fieldset title="local">
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <form:label path="root"><fmt:message key="xmlProvider.xmlpath"/> <span style="color: red">*</span></form:label>
